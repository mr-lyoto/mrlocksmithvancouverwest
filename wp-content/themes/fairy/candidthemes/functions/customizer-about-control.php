...
class Fairy_Customize_Static_Text_Control extends WP_Customize_Control {
	...
	protected function render_content() {
		...
		<div class="description customize-control-description">
			...
			<p>
				<a href="<?php echo esc_url('https://fairy.candidthemes.com/'); ?>" target="_blank"><?php esc_html_e( 'Fairy Demos', 'fairy' ); ?></a>
			</p>
			...
			<p>
				<a href="<?php echo esc_url('https://www.candidthemes.com/support-tickets/'); ?>" target="_blank"><?php esc_html_e( 'Fairy Support', 'fairy' ); ?></a>
			</p>
