            ...
            ?>
                <section class="hero hero-slider-section">
                    <div class="container">
                        ...
                        <div class="home_slick-slider" data-slick='<?php echo $fairy_slider_args_encoded; ?>'>
							<?php if (!empty($has_header_image)) { ?> 
								<img title="Commercial Locksmith Langley" src="<?php echo header_image(); ?>" />
							<?php } ?>
