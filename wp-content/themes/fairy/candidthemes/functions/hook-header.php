                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col col-lg-1-1">
								<span>Mr Locksmith Vancouver West: <a href="tel:(604)760-7620">(604)760-7620</a></span> &nbsp; | &nbsp;
    ...
    ?>
		...
		<div class="container">
			...
			<div style="padding:20px;text-align:center" class="mobile-only">
				<h4>Mr Locksmith Vancouver West: <br /> <a href="tel:(604)760-7620">(604)760-7620</a></h4>
