...
class SpriteGenerator
{
	...
	{
		WPSPEED_DEBUG ? Profiler::start('GenerateSprite') : null;
		...
		WPSPEED_DEBUG ? Profiler::stop('GenerateSprite', true) : null;
	...
	{
		WPSPEED_DEBUG ? Profiler::start('ProcessCssUrls') : null;
		...
		WPSPEED_DEBUG ? Profiler::stop('ProcessCssUrls', true) : null;
