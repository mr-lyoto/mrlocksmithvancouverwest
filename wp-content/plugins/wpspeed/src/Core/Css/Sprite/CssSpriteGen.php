...
class CssSpriteGen
{
	...
	public function __construct( $ImageLibrary, $params, $bBackend = false )
	{
		...
		$class = 'WPSpeed\Core\Css\Sprite\Handlers\\' . ucfirst( $ImageLibrary );
	...
	public function CreateSprite( $aFilePaths )
	{
		...
		{
			WPSPEED_DEBUG ? Profiler::start( 'CalculateSprite' ) : null;
		...
		WPSPEED_DEBUG ? Profiler::stop( 'CalculateSprite', true ) : null;
		...
		WPSPEED_DEBUG ? Profiler::start( 'CreateSprite' ) : null;
...
//                                        $this->sCss .= " } \n";
			...
			WPSPEED_DEBUG ? Profiler::stop( 'CreateSprite', true ) : null;
		}
	}
