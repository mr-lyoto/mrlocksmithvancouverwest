...
use WPSFramework\Inflector\Inflector;
use WPSFramework\Utils\Path;
...
class ViewTemplateFinder
{
	...
	protected $extensions = array('.tmpl.php', '.php');
	...
	public function resolveUriToPath($uri, $layoutTemplate = '', array $extraPaths = array())
	{
		...
		$paths = array(
			...
			// Application tmpl folder (preferred) 
			$this->container->basePath . '/tmpl/' . $parts['view'],
		...
		throw new \Exception('error: ' . $uri, 500);
	}
