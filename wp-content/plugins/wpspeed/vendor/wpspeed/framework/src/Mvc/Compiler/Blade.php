...
class Blade implements CompilerInterface
{
	...
	protected function compileStatementsCallback($match)
	{
		...
		{
			$match[0] = $this->$method(wpspeed_array_get($match, 3));
		}
	...
	{
		return "<?php echo \\WPSFramework\\Text\\Text::_$expression; ?>";
	}
	...
	{
		return "<?php echo \\WPSFramework\\Text\\Text::sprintf$expression; ?>";
	}
	...
	{
		if (wpspeed_starts_with($expression, '('))
		{
	...
	{
		return "<?php \\WPSFramework\\Utils\\Template::addCss{$expression}; ?>";
	}
	...
	{
		return "<?php \\WPSFramework\\Utils\\Template::addJs{$expression}; ?>";
	}
	...
	{
		return "<?php echo \\WPSFramework\\Utils\\Template::parsePath{$expression}; ?>";
	}
