...
class Buffer
{
	...
	/**
	 * Should I register the wpspeed:// stream wrapper
	 *
	...
	public static function canRegisterWrapper()
	{
		if (is_null(static::$canRegisterWrapper))
		{
			...
			// If Suhosin is installed check if wpspeed:// is whitelisted
			if ($hasSuhosin)
			{
...
{
	stream_wrapper_register("awf", "\\WPSFramework\\Utils\\Buffer");
}
