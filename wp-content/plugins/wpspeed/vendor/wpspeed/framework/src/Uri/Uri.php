...
class Uri
{
	...
	/** @var   array  An array of \WPSFramework\Uri\Uri instances. */
	...
	/**
	 * Returns the global \WPSFramework\Uri\Uri object, only creating it
	...
	public static function getInstance($uri = 'SERVER')
	{
		if (empty(self::$instances[$uri]))
		{
			...
			self::$instances[$uri] = new \WPSFramework\Uri\Uri($theURI);
		}
