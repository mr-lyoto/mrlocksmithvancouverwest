...
abstract class Document
{
	 ...
	 *
	 * @return  \WPSFramework\Document\Document
	 */
	public static function getInstance($type, Container $container, $classPrefix = '\\WPSFramework')
	{
		if (!array_key_exists($type, self::$instances))
		{
			...
			{
				$className = '\\WPSFramework\\Document\\Html';
			}
	 ...
	 *
	 * @return \WPSFramework\Application\Application
	 */
