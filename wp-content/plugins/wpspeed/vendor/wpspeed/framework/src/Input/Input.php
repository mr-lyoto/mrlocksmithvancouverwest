...
{
	/** @var   \WPSFramework\Input\Filter  Filter object to use. */
	 ...
	 *
	 * @return  \WPSFramework\Input\Input
	 */
	public function __construct($source = null, $options = [])
	{
		...
		{
			$this->filter = \WPSFramework\Input\Filter::getInstance();
		}
	 ...
	 *
	 * @return  \WPSFramework\Input\Input  The request input object
	 */
	public function __get($name)
	{
		...
		$className = '\\WPSFramework\\Input\\' . ucfirst($name);
		...
		{
			$this->inputs[$name] = new \WPSFramework\Input\Input($GLOBALS[$superGlobal]);
