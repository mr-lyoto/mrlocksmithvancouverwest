...
{
	/**
	 * @var    array  A container for \WPSFramework\Input\Filter instances.
	 */
	 ...
	 *
	 * @return  \WPSFramework\Input\Filter
	 */
	 ...
	 * @param   integer  $xssAuto     Only auto clean essentials = 0, Allow clean blacklisted tags/attr = 1
	 *
	 * @return  \WPSFramework\Input\Filter  The \WPSFramework\Input\Filter object.
	 */
	public static function &getInstance($tagsArray = array(), $attrArray = array(), $tagsMethod = 0, $attrMethod = 0, $xssAuto = 1)
	{
		...
		{
			self::$instances[$sig] = new \WPSFramework\Input\Filter($tagsArray, $attrArray, $tagsMethod, $attrMethod, $xssAuto);
		}
